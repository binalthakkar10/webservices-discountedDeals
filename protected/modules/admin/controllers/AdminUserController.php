...
class AdminUserController extends AdminCoreController
{
	...
	public function actionCreate() {
		$this->pageTitle = "Create Users || Q & A";
		$model = new Users();
	...
	{
		$this->pageTitle = "Upadte Users || Q & A";
	...
	{
		$this->pageTitle = "Manage Users || Q & A";
	...
	{	
		$this->pageTitle = "Change Password || The Roster Network";	
		$model = $this->loadModel($id, 'Users');
		...
		if (isset($_POST['ChangePasswordForm']))
		{
			...
			if($modelData1){
				...
				if($modelForm->validate()){
					...
					$model->username=($_POST['ChangePasswordForm']['username']);
					if ($model->save(false)) {

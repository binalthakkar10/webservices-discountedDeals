...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'buttons'=>array (
        'update'=> array(
            'label'=>'',
            'imageUrl'=>'',
            'url'=>'Yii::app()->createUrl(\'admin/Offers/update\', array(\'id\'=>$data->offer_id))',
            'options'=>array( 'class'=>'icon-edit','title'=>'edit' ),
        ),
        'view'=>array(
            'label'=>'',
            'imageUrl'=>'',
            'url'=>'Yii::app()->createUrl(\'admin/Offers/view\', array(\'id\'=>$data->offer_id))',
            'options'=>array( 'class'=>'icon-search','title'=>'view' ),
        ),
                'delete'=>array(
            'label'=>'',
            'imageUrl'=>'',
            'url'=>'Yii::app()->createUrl(\'admin/Offers/delete\', array(\'id\'=>$data->offer_id))',

<?php 
if(isset($_SESSION['sess_coupon_id'])){ 
$id = $_SESSION['sess_coupon_id'];
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<input type="hidden" id="Coupon_existing_image" name="Coupon[existing_image]" value="<?php if(isset($model->image)) { echo $model->image; } ?>" >
	</div>
    ...
    */?>
    ...
    <?php if(isset($model->image) && !empty($model->image)) { ?>
     <div class="row">
        ...
        <img src="<?php echo Yii::app()->request->baseUrl; ?>/upload/coupon/<?php echo $model->image; ?>" width="20" height="20">        
    </div>
     <?php } ?>
    <?php 
...
<span><a href="<?php echo CController::createUrl('index/tab').'?tabname=business';?>">&lt;&lt;Back</a></span>
<?php /*
    <div class="row">
...
*/?>
     ...
     <div class="row buttons b_sub" id="submit">

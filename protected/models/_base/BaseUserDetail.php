...
abstract class BaseUserDetail extends GxActiveRecord {
	...
	public function rules() {
		return array(
			array('auth_id, username, first_name, last_name, email, phone, password, country, state, location, latitude, longitude, image, device_type, device_token, created_date, user_type', 'required'),
			...
			array('username, first_name, last_name, email, phone, state, latitude, longitude', 'length', 'max'=>100),
			...
			array('user_id, auth_id, auth_provider, username, first_name, last_name, email, phone, password, country, state, location, latitude, longitude, image, device_type, device_token, created_date, updated_date, status, is_active, is_deleted, device_settings, user_type, location_setting', 'safe', 'on'=>'search'),
		);
	}
